...
// 获取用户成就
router.get('/achievements', authMiddleware, personalCenterController.getUserAchievements);

// 获取学习统计数据
router.get('/stats', authMiddleware, personalCenterController.getLearningStats);
