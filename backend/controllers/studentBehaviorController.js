...
exports.getBehaviorOverview = async (req, res) => {
  try {
    ...
    console.log('请求用户ID:', req.user.userId);
    console.log('查询参数:', req.query);
    
    // 支持教师查看特定学生的数据
    const targetStudentId = req.query.studentId;
    const userId = targetStudentId || req.user.userId;
    
    console.log('目标学生ID:', userId);
    console.log('是否为教师查看模式:', !!targetStudentId);
...
exports.getCourseAnalysis = async (req, res) => {
  try {
    ...
    const targetStudentId = req.query.studentId;
    const userId = targetStudentId || requestUserId;
    
    console.log(`📊 获取课程分析 - 请求用户ID: ${requestUserId}, 目标学生ID: ${userId}, 课程ID: ${courseId}`);
...
exports.getLearningTrend = async (req, res) => {
  try {
    ...
    console.log(`📈 获取学习趋势 - 请求用户ID: ${requestUserId}, 目标学生ID: ${userId}, 天数: ${days}`);
...
exports.getPlaybackSpeedUsage = async (req, res) => {
  try {
    ...
    console.log(`⚡ 获取倍速使用情况 - 请求用户ID: ${requestUserId}, 目标学生ID: ${userId}, 课程ID: ${rawCourseId || 'overall'}`);
