...
// 获取倍速播放使用情况统计
router.get('/playback-speed-stats', studentBehaviorController.getPlaybackSpeedUsage);

// 获取课程倍速偏好
router.get('/course-performance', studentBehaviorController.getEnrolledCourses);

// 每日学习时长趋势
router.get('/learning-duration-trend', studentBehaviorController.getLearningTrend);
